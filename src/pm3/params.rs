...
static ALL_PM3_PARAMS: &[Pm3Params] = &[
    ...
    Pm3Params {
        ...
        core_charge: 1.0, heat_of_atomization: 52.102,
        alpha: 3.356386,
    },
    // Carbon
    Pm3Params {
        z: 6, symbol: "C",
        uss: -47.270320, upp: -36.266918,
        beta_s: -11.910015, beta_p: -9.802755,
        zeta_s: 1.565085, zeta_p: 1.842345,
        gss: 11.200708, gsp: 10.265027, gpp: 10.796292, gp2: 9.044175, hsp: 1.582725,
        core_charge: 4.0, heat_of_atomization: 170.89,
        alpha: 2.707807,
    },
    // Nitrogen
    Pm3Params {
        ...
        core_charge: 5.0, heat_of_atomization: 113.00,
        alpha: 2.830545,
    },
    // Oxygen
    Pm3Params {
        z: 8, symbol: "O",
        uss: -86.993002, upp: -71.879580,
        beta_s: -45.202651, beta_p: -24.752515,
        zeta_s: 3.796544, zeta_p: 2.389402,
        gss: 15.755760, gsp: 10.621160, gpp: 13.654016, gp2: 12.406095, hsp: 0.593883,
        core_charge: 6.0, heat_of_atomization: 59.559,
        alpha: 3.217102,
    },
    // Fluorine
    Pm3Params {
        ...
        beta_s: -48.405230, beta_p: -27.744660,
        zeta_s: 4.708555, zeta_p: 2.491178,
        gss: 10.496667, gsp: 16.073689, gpp: 14.817856, gp2: 14.418393, hsp: 0.727763,
        core_charge: 7.0, heat_of_atomization: 18.86,
        alpha: 3.358921,
    },
    // Phosphorus
    Pm3Params {
        z: 15, symbol: "P",
        uss: -40.441400, upp: -29.593012,
        beta_s: -6.753700, beta_p: -6.753700,
        zeta_s: 1.998195, zeta_p: 1.907535,
        gss: 7.800000, gsp: 5.100000, gpp: 7.300000, gp2: 6.500000, hsp: 1.300000,
        core_charge: 5.0, heat_of_atomization: 75.57,
        alpha: 1.943950,
    },
    // Sulfur
    Pm3Params {
        ...
        gss: 8.964667, gsp: 6.785500, gpp: 9.961066, gp2: 7.391876, hsp: 2.532137,
        core_charge: 6.0, heat_of_atomization: 66.40,
        alpha: 2.267302,
    },
    // Chlorine
    Pm3Params {
        z: 17, symbol: "Cl",
        uss: -100.227166, upp: -53.614396,
        beta_s: -27.528560, beta_p: -11.593922,
        zeta_s: 2.246210, zeta_p: 2.151010,
        gss: 16.013810, gsp: 8.013055, gpp: 7.522215, gp2: 7.166017, hsp: 3.481968,
        core_charge: 7.0, heat_of_atomization: 28.99,
        alpha: 2.542201,
    },
    // Bromine
    Pm3Params {
        z: 35, symbol: "Br",
        uss: -116.618200, upp: -74.228400,
        beta_s: -31.171400, beta_p: -6.315200,
        zeta_s: 5.348457, zeta_p: 2.131271,
        gss: 15.036050, gsp: 9.906850, gpp: 7.862200, gp2: 7.399000, hsp: 0.549000,
        core_charge: 7.0, heat_of_atomization: 28.18,
        alpha: 2.455000,
    },
    // Iodine
    Pm3Params {
        z: 53, symbol: "I",
        uss: -103.553600, upp: -74.430400,
        beta_s: -14.409600, beta_p: -5.889600,
        zeta_s: 7.001013, zeta_p: 2.454354,
        gss: 13.613200, gsp: 9.929800, gpp: 6.874100, gp2: 6.131100, hsp: 0.551300,
        core_charge: 7.0, heat_of_atomization: 25.52,
        alpha: 2.144000,
    },
];
...
pub fn count_pm3_electrons(elements: &[u8]) -> usize {
    elements.iter().map(|&z| {
        get_pm3_params(z).map_or(0, |p| p.core_charge as usize)
    }).sum()
}
